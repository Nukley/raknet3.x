...
{
	Write(networkId.systemAddress.binaryAddress);
	Write(networkId.systemAddress.port);
	Write(networkId.localSystemAddress);
}
...
{
	Read(output.systemAddress.binaryAddress);
	Read(output.systemAddress.port);
	return Read(output.localSystemAddress);
}
