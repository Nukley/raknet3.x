...
public:
	...
	/// \note Setting \a isReady to false will fail during the finalization sequence, where any system our the wait list has returned ID_READY_EVENT_ALL_SET
	...
	/// \return True on success. False (failure) on unknown eventId, or during the finalization process
