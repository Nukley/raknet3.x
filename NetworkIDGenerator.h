...
public:
	...
	static void SetExternalSystemAddress(SystemAddress systemAddress);
	static SystemAddress GetExternalSystemAddress(void);
...
private:
	static SystemAddress externalSystemAddress;
